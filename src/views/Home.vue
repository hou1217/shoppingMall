                ...
                <li>
                  <router-link :to="{
                    ...
                    <div class="item_info">
                      ...
                      <p class="items">
                        <span><img src="../assets/images/copy 5.png"> x2</span>
                        <span><img src="../assets/images/copy 1.png"> x22</span>
                        <span><img src="../assets/images/copy 5.png"> x2</span>
                      </p>
                    </div>
                  </router-link>
                ...
                <li>
                  <router-link :to="{
                    ...
                    <div class="item_info">
                      ...
                      <p class="items">
                        <span class="gold"><img src="../assets/images/chat_gift_gold.png"> 3000</span>
                        <span><img src="../assets/images/copy 1.png"> x22</span>
                        <span><img src="../assets/images/copy 5.png"> x2</span>
                      </p>
                    </div>
  ...
  methods:{
    ...
    getDatas(pay){
      ...
      if(this.flag2){
        ...
        const options = {
          ...
          url:this.GLOBAL.serverUrl+'/media-dc/index'+'?category='+pay.kind
        };
        axios(options)
          .then(function (res){
    ...
    loadMoreDatas(payload,mode){
      ...
      const options = {
        ...
        url:mode?this.GLOBAL.serverUrl+'/media-dc/more'+'?category='+payload.kind+'&type=new':this.GLOBAL.serverUrl+'/media-dc/more'+'/?category='+payload.kind+'&type=history'
      };
      axios(options)
          .then(function(res){
